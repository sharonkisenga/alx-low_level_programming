 ...
 * @e_ident: pointer to an array containing a ELF
 ...
 * @e_ident: pointer to the rray containing the ELF magic numbers
...
/**
 * print_class - print the clas of an ELF header
 ...
 * @e_ident: pointer the array containing an ELF class
 */
void print_data(unsigned char *e_ident)
{
	printf("Data: ");
...
/**
 * print_abi - print the ABI version of an ELF 
 * @e_ident; pointer to an array containing an ELF ABI
 */
void print_abi(unsigned char *e_ident)
{
